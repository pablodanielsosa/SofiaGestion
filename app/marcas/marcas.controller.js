...
'use strict';
    ...
    MarcasController.$inject = ['toastr', '$scope', '$uibModal', '$uibModalStack', '$log', '$templateCache', 'ApiService', 'ModalService', 'MESSAGES'];
    function MarcasController(toastr, $scope, $uibModal, $uibModalStack, $log, $templateCache, ApiService, ModalService, MESSAGES) {
        ...
        function fnEliminar(item){
            if(confirm("¿Estas seguro de eliminar el registro?")){
                ApiService.fcGetDataSlim('/marcas/eliminar?id='+item.id_marca).then(function (data) {
        ...
        function fnEditar(item){
           ...
           var configuracion = {
               templateUrl: "app/marcas/marcas.abm.html",
               controller: "MarcasModalController",
               parametros: {
                   accion: "Editar_Marca",
                   item:item
               },
        ...
        function fcBuscar(){
            ...
            fcArmarListaPaginada('marcas',  '/marcas/listado/', 1, query);
