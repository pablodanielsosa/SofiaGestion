...
'use strict';
    ...
    UsuariosController.$inject = ['toastr', '$scope', '$uibModal', '$uibModalStack', '$log', '$templateCache', 'ApiService', 'ModalService', 'MESSAGES'];
    function UsuariosController(toastr, $scope, $uibModal, $uibModalStack, $log, $templateCache, ApiService, ModalService, MESSAGES) {
        ...
        function fnEliminar(item){
            if(confirm("¿Estas seguro de eliminar el registro?")){
                ApiService.fcGetDataSlim('/usuarios/eliminar?id='+item.id_usuario).then(function (data) {
        ...
        function fnEditar(item){
           ...
           var configuracion = {
               templateUrl: "app/usuarios/usuarios.abm.html",
        ...
        function fcBuscar(){
            ...
            fcArmarListaPaginada('usuarios',  '/usuarios/listado/', 1, query);
