...
'use strict';
    ...
    CategoriasController.$inject = ['toastr', '$scope', '$uibModal', '$uibModalStack', '$log', '$templateCache', 'ApiService', 'ModalService', 'MESSAGES'];
    function CategoriasController(toastr, $scope, $uibModal, $uibModalStack, $log, $templateCache, ApiService, ModalService, MESSAGES) {
        ...
        function fnEliminar(item){
            if(confirm("¿Estas seguro de eliminar el registro?")){
                ApiService.fcGetDataSlim('/categorias/eliminar?id='+item.id_categoria).then(function (data) {
        ...
        function fnEditar(item){
           ...
           var configuracion = {
               templateUrl: "app/categorias/categorias.abm.html",
               controller: "CategoriasModalController",
               parametros: {
        ...
        function fcBuscar(){
            ...
            fcArmarListaPaginada('categorias',  '/categorias/listado/', 1, query);
