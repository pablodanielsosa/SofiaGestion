...
'use strict';
    ...
    ProveedoresController.$inject = ['toastr', '$scope', '$uibModal', '$uibModalStack', '$log', '$templateCache', 'ApiService', 'ModalService', 'MESSAGES'];
    function ProveedoresController(toastr, $scope, $uibModal, $uibModalStack, $log, $templateCache, ApiService, ModalService, MESSAGES) {
        ...
        function fnEliminar(item){
            if(confirm("¿Estas seguro de eliminar el registro?")){
                ApiService.fcGetDataSlim('/proveedores/eliminar?id='+item.id_proveedor).then(function (data) {
        ...
        function fnEditar(item){
           ...
           var configuracion = {
               templateUrl: "app/proveedores/proveedores.abm.html",
               controller: "ProveedoresModalController",
               parametros: {
        ...
        function fcBuscar(){
            ...
            if(vm.form.nombre == null){vm.form.nombre = '';};
            
            query += 'nombre=' + vm.form.nombre;
            
            fcArmarListaPaginada('proveedores',  '/proveedores/listado/', 1, query);
